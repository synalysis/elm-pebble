...
#define ELMC_PEBBLE_FEATURE_CMD_STORAGE_DELETE 1
...
#define ELMC_PEBBLE_FEATURE_CMD_GET_CURRENT_TIME_STRING 1
...
#define ELMC_PEBBLE_FEATURE_CMD_GET_CLOCK_STYLE_24H 1
#define ELMC_PEBBLE_FEATURE_CMD_GET_TIMEZONE_IS_SET 1
#define ELMC_PEBBLE_FEATURE_CMD_GET_TIMEZONE 1
#define ELMC_PEBBLE_FEATURE_CMD_GET_WATCH_MODEL 1
#define ELMC_PEBBLE_FEATURE_CMD_GET_WATCH_COLOR 1
#define ELMC_PEBBLE_FEATURE_CMD_GET_FIRMWARE_VERSION 1
