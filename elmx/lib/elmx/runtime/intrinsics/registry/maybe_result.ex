defmodule Elmx.Runtime.Intrinsics.Registry.MaybeResult do
  ...
  def handlers do
    %{
      ...
      "elmc_maybe_map3" => {MaybeResult, :maybe_map3},
      "elmc_maybe_map4" => {MaybeResult, :maybe_map4},
      "elmc_maybe_map5" => {MaybeResult, :maybe_map5},
      "elmc_maybe_and_then" => {MaybeResult, :maybe_and_then},
      "elmc_result_map" => {MaybeResult, :result_map},
      "elmc_result_map2" => {MaybeResult, :result_map2},
      "elmc_result_map3" => {MaybeResult, :result_map3},
      "elmc_result_map4" => {MaybeResult, :result_map4},
      "elmc_result_map5" => {MaybeResult, :result_map5},
