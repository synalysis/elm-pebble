defmodule Elmx.Runtime.Pebble.Registry.Cmd do
  ...
  def handlers do
    %{
      ...
      "elmx_wss_error_to_string" => {Values, :wss_error_to_string},
      "elmx_wss_error_kind_to_string" => {Values, :wss_error_kind_to_string},
      "elmx_wss_decode_event" => {Values, :wss_decode_event},
