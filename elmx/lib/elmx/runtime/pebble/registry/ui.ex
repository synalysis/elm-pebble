defmodule Elmx.Runtime.Pebble.Registry.Ui do
  ...
  def handlers do
    base =
      for fun <- ~w(
             window_stack window canvas_layer group context draw_bitmap_in_rect clear fill_rect
             text text_int text_label rect circle fill_circle fill_radial pixel round_rect arc path
             path_outline path_filled path_outline_open rotation_from_degrees draw_vector_at
             draw_vector_sequence_at draw_bitmap_sequence_at draw_rotated_bitmap compositing_mode
             named_color
           )a,
           into: %{} do
        {"elmx_ui_#{fun}", {Ui, fun}}
