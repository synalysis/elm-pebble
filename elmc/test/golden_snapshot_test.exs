defmodule Elmc.GoldenSnapshotTest do
  ...
  test "generated c contains concrete helper calls for lowered expressions" do
    ...
    {:ok, _} = CachedCompile.compile(project_dir, %{out_dir: out_dir, strip_dead_code: false, plan_ir_mode: :primary})
    ...
    assert branch_out =~ "elmc_tuple_first_borrow(value)"
    assert branch_out =~ "elmc_tuple_second_borrow(value)"
