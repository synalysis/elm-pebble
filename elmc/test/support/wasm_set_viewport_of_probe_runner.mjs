...
if (!buildDir) {
  console.error("usage: wasm_set_viewport_of_probe_runner.mjs <buildDir>");
  process.exit(2);
}
...
if (innerText !== "7,8") {
  console.error(
    `expected setViewportOf box 7 8 then getViewportOf, got ${JSON.stringify(innerText)}`
  );
  process.exit(1);
}
...
console.log("rc_ok set_viewport_of_ok");
