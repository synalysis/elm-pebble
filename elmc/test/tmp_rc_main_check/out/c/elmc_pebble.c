...
static int elmc_msg_constructor_arity(elmc_int_t tag) {
  switch (tag) {
      case ELMC_PEBBLE_MSG_LEFTPRESSED: return 0;
      case ELMC_PEBBLE_MSG_RIGHTPRESSED: return 0;
      case ELMC_PEBBLE_MSG_UPPRESSED: return 0;
      case ELMC_PEBBLE_MSG_DOWNPRESSED: return 0;
      case ELMC_PEBBLE_MSG_BESTLOADED: return 1;
      case ELMC_PEBBLE_MSG_RANDOMGENERATED: return 1;
    default: return 0;
  }
}
...
int elmc_pebble_msg_from_appmessage(int32_t key, int32_t value, int64_t *out_tag) {
  ...
  if (key == 0) {
    switch (value) {
      case ELMC_PEBBLE_MSG_LEFTPRESSED: *out_tag = 1; return 0;
      case ELMC_PEBBLE_MSG_RIGHTPRESSED: *out_tag = 2; return 0;
      case ELMC_PEBBLE_MSG_UPPRESSED: *out_tag = 3; return 0;
      case ELMC_PEBBLE_MSG_DOWNPRESSED: *out_tag = 4; return 0;
      case ELMC_PEBBLE_MSG_BESTLOADED: *out_tag = 5; return 0;
      case ELMC_PEBBLE_MSG_RANDOMGENERATED: *out_tag = 6; return 0;
      default: return -3;
    }
  }
...
int elmc_pebble_dispatch_random_int(ElmcPebbleApp *app, int32_t value) {
  if (!app || !app->initialized) return -1;
  if (6 <= 0) return -6;
  return elmc_pebble_dispatch_tag_value(app, 6, value);
}
