...
#define ELMC_PEBBLE_FEATURE_CMD_RANDOM_GENERATE 1
...
typedef enum {
  ...
  ELMC_PEBBLE_MSG_LEFTPRESSED = 1,
  ELMC_PEBBLE_MSG_RIGHTPRESSED = 2,
  ELMC_PEBBLE_MSG_UPPRESSED = 3,
  ELMC_PEBBLE_MSG_DOWNPRESSED = 4,
  ELMC_PEBBLE_MSG_BESTLOADED = 5,
  ELMC_PEBBLE_MSG_RANDOMGENERATED = 6,
} ElmcPebbleMsgTag;

#define ELMC_PEBBLE_HAS_MSG_LEFTPRESSED 1
#define ELMC_PEBBLE_HAS_MSG_RIGHTPRESSED 1
#define ELMC_PEBBLE_HAS_MSG_UPPRESSED 1
#define ELMC_PEBBLE_HAS_MSG_DOWNPRESSED 1
#define ELMC_PEBBLE_HAS_MSG_BESTLOADED 1
#define ELMC_PEBBLE_HAS_MSG_RANDOMGENERATED 1
