defmodule Elmc.PlanSurfaceCoverageTest do
  ...
  test "pebble_surface_project primary emits plan C for all Main functions" do
    ...
    assert view_append_body =~ "elmc_fn_Main_parseHourFromTimeString(" or
             view_append_body =~ "elmc_fn_Main_parseHourFromTimeString_native(" or
             view_append_body =~ "// inlined Main.parseHourFromTimeString"
