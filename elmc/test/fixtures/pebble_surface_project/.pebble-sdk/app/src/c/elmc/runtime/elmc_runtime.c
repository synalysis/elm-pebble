...
/* ================================================================
   Standard Library – Json.Decode (stubs)
   ================================================================ */

ElmcValue *elmc_json_decode_value(ElmcValue *decoder, ElmcValue *value) {
  (void)decoder;
  return elmc_result_err(elmc_new_string("Json.Decode not implemented"));
}
...
/* ================================================================
   Standard Library – Json.Encode (stubs)
   ================================================================ */
