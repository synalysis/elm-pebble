...
#define ELMC_WORKER_SUB_TAG_SLOTS 7
#define ELMC_WORKER_SLOT_APPMESSAGE 1
#define ELMC_WORKER_SLOT_BATTERY 3
#define ELMC_WORKER_SLOT_CONNECTION 2
#define ELMC_WORKER_SLOT_HEALTH 0
#define ELMC_WORKER_SLOT_HOUR_CHANGE 5
#define ELMC_WORKER_SLOT_MINUTE_CHANGE 6
#define ELMC_WORKER_SLOT_SECOND_CHANGE 4
