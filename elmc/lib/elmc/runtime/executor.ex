defmodule Elmc.Runtime.Executor do
  ...
  @spec map_value(Types.execution_request() | Types.runtime_model(), atom()) ::
          Types.dynamic_value()
  ...
  @spec normalize_update_branches(Types.update_branches() | nil) :: Types.update_branches()
  ...
  @spec view_tree_node_count(Types.view_tree()) :: non_neg_integer()
