defmodule Elmc.Backend.Plan.Fusion.Matchers.IntStringCase do
  @moduledoc false
  ...
  alias Elmc.Backend.CCodegen.{CSource, EnvBindings, Native.IntCase, RcRuntimeEmit, Util}
  ...
  @spec int_string_lut_eligible?(list()) :: boolean()
