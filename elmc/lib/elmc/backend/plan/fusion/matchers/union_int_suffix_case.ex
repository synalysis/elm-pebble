defmodule Elmc.Backend.Plan.Fusion.Matchers.UnionIntSuffixCase do
  @moduledoc false
  ...
  alias Elmc.Backend.CCodegen.{ConstructorTagCase, CSource, EnvBindings, Host, IntLiteralRef, Native.Int, RcRuntimeEmit, Util}

  alias Elmc.Backend.CCodegen.Native.String, as: NativeStringMod

  @buf_size 22

  @type emit_ok :: {:ok, String.t(), [FusionSupport.callee_key()], :rc_native}
  @type branch_spec :: {map(), String.t(), String.t(), Types.expr()}
  @type maybe_source ::
          {:map_field, String.t(), String.t(), String.t()}
          | {:maybe_field, String.t(), String.t()}
  @type wire_expr :: %{kind: :var} | %{kind: :scaled, offset: integer(), divisor: integer()}
  @type wire_branch :: %{
          tag: integer(),
          prefix: String.t(),
          suffix: String.t(),
  ...
  @spec try_emit_direct_union_suffix(String.t(), String.t(), Types.expr(), Types.decl_map()) ::
          emit_ok() | :error
  ...
  @spec try_emit_maybe_union_suffix(String.t(), String.t(), Types.expr(), Types.decl_map()) ::
          emit_ok() | :error
  ...
  @spec emit_rc_native_helper(String.t(), String.t(), String.t(), String.t()) :: emit_ok()
  ...
  @spec emit_native_suffix_switch(String.t(), [branch_spec()], Types.compile_env()) :: String.t()
  ...
  @spec branch_specs([map()]) :: {:ok, [branch_spec()]} | :error
  ...
  @spec union_int_suffix_eligible?([map()]) :: boolean()
  ...
  @spec parse_suffix_append(Types.expr(), String.t()) ::
          {:ok, String.t(), String.t(), Types.expr()} | :error
  ...
  @spec append_parts(term()) :: {:ok, term(), term()} | :error
  ...
  @spec int_expr_references_payload?(term(), String.t()) :: boolean()
  ...
  @spec subtree_references_var?(term(), String.t()) :: boolean()
  ...
  @spec payload_var(term()) :: {:ok, String.t()} | :error
  ...
  @spec payload_var_name() :: String.t()

  defp payload_var_name, do: "__union_payload_int__"

  @spec snprintf_format(String.t(), String.t()) :: String.t()
  ...
  @spec message_tag_expr(String.t()) :: String.t()
  ...
  @spec case_label(map(), Types.compile_env()) :: String.t()
  ...
  @spec parse_case(term()) :: {:ok, nil, list()} | :error
  ...
  @spec parse_maybe_union_case(term()) :: {:ok, maybe_source(), list()} | :error
  ...
  @spec parse_maybe_union_source(term()) :: {:ok, maybe_source()} | :error
  ...
  @spec param_field_access(term()) :: {:ok, String.t(), String.t()} | :error
  ...
  @spec param_matches_source?(String.t(), maybe_source()) :: boolean()
  ...
  @spec nothing_branch_text([map()]) :: {:ok, String.t()} | :error
  ...
  @spec maybe_nothing_branch?(term()) :: boolean()
  ...
  @spec maybe_union_branch_specs([map()]) :: {:ok, [branch_spec()]} | :error
  ...
  @spec maybe_union_branch_spec(term()) :: {:ok, branch_spec()} | :skip | :error
  ...
  @spec just_union_pattern(term()) :: {:ok, map()} | :error
  ...
  @spec record_param_type(String.t(), String.t(), Types.decl_map()) :: {:ok, String.t()} | :error
  ...
  @spec nested_record_type_name(String.t(), String.t(), String.t()) :: {:ok, String.t()} | :error
  ...
  @spec extract_direct_union_data(Types.expr()) :: {:ok, Types.fusion_metadata()} | :error
  ...
  @spec extract_maybe_union_data(String.t(), String.t(), Types.expr(), Types.decl_map()) ::
          {:ok, Types.fusion_metadata()} | :error
  ...
  @spec wire_branch_specs([branch_spec()]) :: [wire_branch()] | :error
  ...
  @spec wire_branch_spec(branch_spec()) :: {:ok, wire_branch()} | :error
  ...
  @spec union_branch_tag(term()) :: {:ok, integer()} | :error
  ...
  @spec wire_int_expr(Types.expr(), String.t()) :: {:ok, wire_expr()} | :error
  ...
  @spec int_expr_var?(term(), String.t()) :: boolean()
  ...
  @spec wire_scaled_expr(Types.expr(), String.t()) :: {:ok, wire_expr()} | :error
  ...
  @spec idiv_parts(term()) :: {:ok, term(), integer()} | :error
  ...
  defp idiv_parts(_), do: :error

  @spec add_const_offset(term(), String.t()) :: {:ok, integer()} | :error
