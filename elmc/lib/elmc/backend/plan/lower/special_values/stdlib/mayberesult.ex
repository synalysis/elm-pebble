defmodule Elmc.Backend.Plan.Lower.SpecialValues.Stdlib.MaybeResult do
  @moduledoc false
  ...
  def special_value_from_target(target, [])
      when target in ["Nothing", "Maybe.Nothing"],
      do: %{op: :runtime_call, function: "elmc_maybe_nothing", args: []}
