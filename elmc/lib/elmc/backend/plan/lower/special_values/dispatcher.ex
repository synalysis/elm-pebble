defmodule Elmc.Backend.Plan.Lower.SpecialValues.Dispatcher do
  @moduledoc false
  ...
  alias Elmc.Backend.Plan.Lower.SpecialValues.Stdlib.String, as: StdlibString
  ...
  defp dispatch_handlers(target, args) do
    ...
    if is_nil(result) do
      UnsupportedSurface.record_missing_special(target, args)
    end
