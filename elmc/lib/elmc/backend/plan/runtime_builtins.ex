defmodule Elmc.Backend.Plan.RuntimeBuiltins do
  ...
  @builtins Map.merge(%{
    ...
    cmd_companion_send_value: "elmc_cmd_companion_send_value",
    ...
    debug_dict_to_string: "elmc_debug_dict_to_string",
    debug_array_to_string: "elmc_debug_array_to_string",
  ...
  @fallible MapSet.new([
    ...
    :debug_to_string,
    :debug_set_to_string,
    :debug_dict_to_string,
    :debug_array_to_string,
    :debug_log,
    :string_length_boxed,
    :tuple2,
    :tuple2_take,
