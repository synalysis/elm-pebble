defmodule Elmc.Backend.CCodegen.DebugProbes do
  ...
  def entry_exit_probes("Main", name) do
    case name do
  ...
  def entry_exit_probes("Pebble.Ui", "toUiNode"),
  ...
  def append_probe(env, "elmc_append", result_var, counter) do
    if Map.get(env, :__module__) == "Main" and Map.get(env, :__function_name__) == "faceOps" do
