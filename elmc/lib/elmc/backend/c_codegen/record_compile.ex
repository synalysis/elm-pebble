defmodule Elmc.Backend.CCodegen.RecordCompile do
  ...
  @spec compile_field_access(map(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_result()
  ...
  @spec compile_inline_boxed_literal(
          Types.ir_record_fields(),
          non_neg_integer(),
          Types.compile_env(),
          Types.compile_counter()
  ...
  @spec record_values_array([String.t()]) :: String.t()
  ...
  @spec put_literal_record_meta(String.t(), Types.ir_record_fields(), Types.compile_env()) :: :ok
  ...
  @spec unique_field_refs([String.t()]) :: [String.t()]
  ...
  @spec remap_literal_fields(Types.ir_record_fields(), [String.t()]) ::
          {:ok, Types.ir_record_fields()} | :error
  ...
  @spec record_field_types_for_type(String.t(), Types.compile_env()) :: %{String.t() => String.t()} | nil
  ...
  @spec canonicalize_literal_fields(Types.ir_record_fields(), Types.compile_env()) ::
          Types.ir_record_fields()
  ...
  @spec maybe_extract_boxed_record_literal_helper(
          Types.ir_record_fields(),
          non_neg_integer(),
          Types.compile_env(),
          Types.compile_counter()
  ...
  @spec record_literal_helper_params(Types.ir_record_fields(), Types.compile_env()) ::
          {:ok, [{String.t(), String.t(), :boxed | :native_int | :native_bool}]} | :error
  ...
  @spec resolve_record_helper_param(Types.compile_env(), String.t()) ::
          :skip | {:ok, {String.t(), String.t(), :boxed | :native_int | :native_bool}} | :error
  ...
  @spec record_update_result_slot(Types.compile_env(), Types.compile_counter(), boolean()) ::
  ...
  @spec retain_in_place_cow_result(
          String.t(),
          String.t(),
          String.t(),
          Types.compile_env(),
  ...
  @spec in_place_cow_record_base?(Types.compile_env(), String.t()) :: boolean()
  ...
  @spec base_owned_copy_release?(Types.compile_env(), String.t(), String.t()) :: boolean()
  ...
  @spec base_fresh_owned?(map() | Types.expr(), String.t(), boolean(), Types.compile_env()) ::
          boolean()
  ...
  @spec record_update_multi_use_names(Types.ir_record_fields()) :: MapSet.t(String.t())
  ...
  @spec defer_record_update_field_release?(map() | Types.expr(), String.t(), MapSet.t(String.t())) ::
          boolean()
  ...
  @spec maybe_extract_chained_update_helper(
          Types.expr(),
          Types.ir_record_fields(),
          Types.compile_env(),
          String.t(),
  ...
  @spec extract_chained_update_helper?(non_neg_integer(), String.t()) :: boolean()

  defp extract_chained_update_helper?(field_count, _code) do
    Process.get(:elmc_generic_helper_defs) != nil and field_count >= 5
  end

  @spec chained_update_helper_params(Types.expr(), Types.ir_record_fields(), Types.compile_env()) ::
          {:ok, [{String.t(), String.t(), :boxed | :native_int | :native_bool}]} | :error
  ...
  @spec compile_update_operand(map() | Types.expr(), Types.compile_env(), Types.compile_counter()) ::
  ...
  @spec compile_record_field_update_operand(
          Types.ir_record_field(),
          Types.compile_env(),
          Types.compile_counter(),
          Types.record_shape(),
          String.t() | nil
  ...
  @spec record_field_is_int?(String.t(), Types.record_shape(), String.t() | nil, Types.compile_env()) ::
          boolean()
  ...
  @spec record_field_is_bool?(String.t(), Types.record_shape(), String.t() | nil, Types.compile_env()) ::
          boolean()
  ...
  @spec record_field_is_float?(String.t(), Types.record_shape(), String.t() | nil, Types.compile_env()) ::
          boolean()
  ...
  @spec record_field_is_scalar?(String.t(), String.t(), Types.compile_env(), String.t()) :: boolean()
  ...
  @spec inline_immortal_record_field_operand(String.t(), String.t()) :: {String.t(), String.t()}
  ...
  @spec parse_single_immortal_assign(String.t(), String.t()) :: {:ok, String.t()} | :error
  ...
  @spec immortal_inline_rhs?(String.t()) :: boolean()
  ...
  @spec borrowed_projection_operand?(String.t(), String.t()) :: boolean()
  ...
  @spec update_operand_release(String.t(), boolean()) :: String.t()
  ...
  @spec zero_arg_function_var?(Types.compile_env(), String.t() | atom()) :: boolean()
  ...
  @spec mark_borrowed_record_field_ref(String.t(), String.t()) :: :ok
  ...
  @spec borrowed_record_field_getter?(String.t()) :: boolean()
  ...
  @spec compile_boxed_field_value_expr(map() | Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_result()
  ...
  @spec compile_boxed_non_union_field_value(Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_result()
  ...
  @spec compile_boxed_union_field_value(map() | Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_ok_result()
  ...
  @spec compile_boxed_union_tag_int(Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_ok_result()
  ...
  @spec compile_boxed_union_tag_int_ref(Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          Types.compile_ok_result()
  ...
  @spec union_ctor_tag_ref(map()) :: integer() | nil
  ...
  @spec lookup_ir_constructor_tag_by_name(String.t()) :: integer() | nil
  ...
  @spec compile_field_exprs(
          Types.ir_record_fields(),
          Types.compile_env(),
          Types.compile_counter(),
          (Types.expr(), Types.compile_env(), Types.compile_counter() -> Types.compile_result())
        ) :: {String.t(), [String.t()], Types.compile_counter(), String.t()}
  ...
  @spec record_subexpr_cache_env(Types.compile_env()) :: Types.compile_env()
  ...
  @spec field_subexpr_cache_env(Types.compile_env()) :: Types.compile_env()
  ...
  @spec release_compare_operand_var(String.t()) :: String.t()
  ...
  @spec mark_shared_subexpr_ref(Types.compile_env(), String.t()) :: Types.compile_env()
  ...
  @spec sync_record_subexpr_cache(Types.compile_env(), Types.compile_env()) :: Types.compile_env()
  ...
  @spec get_field_subexpr_cache(Types.compile_env()) :: Types.subexpr_cache_map()
  ...
  @spec put_field_subexpr_cache(Types.compile_env(), Types.subexpr_cache_map()) :: Types.compile_env()
  ...
  @spec take_field_subexpr_cache(Types.compile_env()) :: Types.subexpr_cache_map()
  ...
  @spec get_record_subexpr_cache(Types.compile_env()) :: Types.subexpr_cache_map()
  ...
  @spec put_record_subexpr_cache(Types.compile_env(), Types.subexpr_cache_map()) :: Types.compile_env()
  ...
  @spec take_record_subexpr_cache(Types.compile_env()) :: Types.subexpr_cache_map()
  ...
  @spec lookup_subexpr_cache(Types.compile_env(), Types.subexpr_cache_key()) ::
          {:field_hit, String.t()} | {:record_hit, String.t()} | :miss
  ...
  @spec store_subexpr_cache(Types.compile_env(), Types.subexpr_cache_key(), String.t()) ::
          Types.compile_env()
  ...
  @spec compile_cached_field_access(
          Types.expr(),
          Types.expr(),
          String.t(),
          Types.compile_env(),
  ...
  @spec compile_cached_boxed_native_int_field(
          Types.expr(),
          String.t(),
          Types.compile_env(),
          Types.compile_counter()
  ...
  @spec compile_cached_field_access_impl(
          Types.expr(),
          Types.expr(),
          String.t(),
          Types.compile_env(),
  ...
  @spec record_field_get_expr(String.t(), String.t(), Types.expr(), Types.compile_env()) :: String.t()
  ...
  @spec record_field_container_meta(map() | Types.expr(), Types.compile_env()) ::
          {Types.record_shape(), String.t() | nil}
  ...
  @spec nested_record_container_meta(Types.compile_env(), map() | Types.expr(), String.t()) ::
          {Types.record_shape(), String.t()} | nil
  ...
  @spec record_container_decl_type(map() | Types.expr(), Types.compile_env()) :: String.t() | nil
  ...
  @spec record_container_shape(String.t() | map() | Types.expr(), Types.compile_env()) ::
          Types.record_shape()
  ...
  @spec record_container_type(String.t() | map() | Types.expr(), Types.compile_env()) ::
          String.t() | nil
  ...
  @spec subexpr_record_meta_for_field_access(Types.compile_env(), Types.expr(), String.t()) ::
          Types.subexpr_record_meta()
  ...
  @spec runtime_record_field_access?(Types.expr(), map() | Types.expr(), String.t()) :: boolean()
  ...
  @spec record_field_arg?(map() | Types.expr()) :: boolean()
  ...
  @spec compile_cached_field_access_bound_name(String.t(), Types.compile_env(), Types.compile_counter()) ::
          {String.t(), String.t(), Types.compile_counter(), Types.compile_env(), boolean()}
  ...
  @spec compile_cached_field_access_arg(map() | Types.expr(), Types.compile_env(), Types.compile_counter()) ::
          {String.t(), String.t(), Types.compile_counter(), Types.compile_env(), boolean()}
  ...
  @spec deferred_cache_release_refs(Types.compile_env(), [String.t()], String.t()) :: [String.t()]
  ...
  @spec record_field_source_release_refs([String.t()], String.t(), keyword()) :: [String.t()]
  ...
  @spec releases_to_code([String.t()]) :: String.t()
  ...
  @spec field_ref_still_uses_cache_ref?(String.t(), [String.t()]) :: boolean()
  ...
  @spec post_record_cache_release_refs(
          Types.compile_env(),
          [String.t()],
          String.t(),
          MapSet.t(String.t())
  ...
  @spec orphan_cache_release?(String.t(), String.t()) :: boolean()
  ...
  @spec released_vars_in_code(String.t()) :: MapSet.t(String.t())
  ...
  @spec released_in_field_code?(String.t(), String.t()) :: boolean()
  ...
  @spec subexpr_key(map() | Types.expr()) :: Types.subexpr_cache_key()
  ...
  @spec boxed_release_var?(String.t()) :: boolean()

  defp boxed_release_var?(var) do
    Util.boxed_temp_var?(var) and not EnvBindings.borrowed_arg_ref?(%{}, var)
  end

  @spec native_boxed_rc_env(Types.compile_env()) :: Types.compile_env()
