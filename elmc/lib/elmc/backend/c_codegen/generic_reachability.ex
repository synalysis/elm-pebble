defmodule Elmc.Backend.CCodegen.GenericReachability do
  ...
  @spec merged_callees(Types.function_decl_key(), Types.expr(), Types.decl_map()) :: [
          Types.function_decl_key()
        ]
  ...
  @spec merged_wrapper_callees(Types.function_decl_key(), Types.expr(), Types.decl_map()) :: [
          Types.function_decl_key()
        ]
  ...
  @spec expr_wrapper_callees_list(Types.expr() | list() | term(), String.t(), Types.decl_map()) :: [
          Types.function_decl_key()
        ]
  ...
  @spec expr_callees_list(Types.expr() | list() | term(), String.t(), Types.decl_map()) :: [
          Types.function_decl_key()
        ]
  ...
  @spec local_decl_callee(String.t(), String.t(), Types.decl_map()) :: [Types.function_decl_key()]
  ...
  @spec wrapper_callee_child_values(Types.expr()) :: [term()]
