defmodule Ide.Debugger.DebuggerContractTest do
  ...
  test "analyze_source extracts init model, Msg tags, and view outline" do
    ei = ContractTestSupport.analyze_contract!(@mini_elm, "Snap.elm")
  ...
  test "analyze_source strips utf-8 bom for source-derived header scans" do
    ...
    ei = ContractTestSupport.analyze_contract!(src, "Snap.elm")
  ...
  test "analyze_source view tree keeps literal and field_access labels for draw args" do
    ei = ContractTestSupport.analyze_contract!(@numeric_view_elm, "NumericView.elm")
  ...
  test "analyze_source keeps drawable nodes for let-based canvas view" do
    ei = ContractTestSupport.analyze_contract!(@let_canvas_view_elm, "LetCanvasView.elm")
  ...
  test "analyze_source preserves shorthand arithmetic operands in view tree" do
    ...
    ei = ContractTestSupport.analyze_contract!(source, "ShorthandArithmeticView.elm")
  ...
  test "analyze_source keeps drawable nodes for watchface digital template source" do
    ...
    ei = ContractTestSupport.analyze_contract!(source, "Main.elm")
  ...
  test "analyze_source annotates UI view nodes with source locations" do
    ...
    ei = ContractTestSupport.analyze_contract!(source, "watch/src/Main.elm")
  ...
  test "parser_expression_view detects custom UiNode wrappers by return type metadata" do
    ...
    assert ElmEx.DebuggerContract.parser_expression_view?(%{"debugger_contract" => ei})

    root = get_in(ei, ["view_tree"])
    assert ElmEx.DebuggerContract.parser_expression_view_tree_node?(root, ei)
    refute ElmEx.DebuggerContract.parser_expression_structural_type?("packUi")
  ...
  test "parser_expression_view detects renamed UiNode wrappers via return_kind metadata" do
    ...
    assert ElmEx.DebuggerContract.parser_expression_view?(%{"debugger_contract" => ei})
    refute ElmEx.DebuggerContract.parser_expression_view_tree_node?(%{"type" => "toUiNode"}, ei)
  end
  ...
  test "analyze_source extracts structured update command calls with callback constructor" do
    ei = ContractTestSupport.analyze_contract!(@cmd_calls_elm, "CmdCalls.elm")
  ...
  test "analyze_source strips block comments before source-derived scans" do
    ei = ContractTestSupport.analyze_contract!(@with_block_comment, "DocMod.elm")
  ...
  test "analyze_source strips trailing line comments on source-derived header lines" do
    ei = ContractTestSupport.analyze_contract!(@with_eol_comments, "Eol.elm")
  ...
  test "analyze_source lists explicit imported_modules without implicit core" do
    ei = ContractTestSupport.analyze_contract!(@with_imports, "Imp.elm")
  ...
  test "analyze_source accepts import after flexible whitespace" do
    ei = ContractTestSupport.analyze_contract!(@import_flexible_ws, "Spc.elm")
  ...
  test "analyze_source accepts flexible whitespace in import exposing clause" do
    ei = ContractTestSupport.analyze_contract!(@import_exposing_flex, "ExpWs.elm")
  ...
  test "analyze_source accepts flexible whitespace around import as" do
    ei = ContractTestSupport.analyze_contract!(@import_as_flex, "AsFlex.elm")
  ...
  test "analyze_source captures import as and exposing clauses from source" do
    ei = ContractTestSupport.analyze_contract!(@import_syn, "ISyn.elm")
  ...
  test "analyze_source joins multiline import exposing lists" do
    ei = ContractTestSupport.analyze_contract!(@import_multiline, "IMl.elm")
  ...
  test "analyze_source parses import exposing with nested (..) in one line" do
    ei = ContractTestSupport.analyze_contract!(@import_nested_paren, "INest.elm")
  ...
  test "analyze_source splits import exposing on commas not inside type parens" do
    ei = ContractTestSupport.analyze_contract!(@import_exposing_commas_in_types, "ITy.elm")
  ...
  test "analyze_source splits module exposing on commas not inside type parens" do
    ei = ContractTestSupport.analyze_contract!(@module_exposing_commas_in_types, "MTy.elm")
  ...
  test "analyze_source parses explicit module exposing list from header" do
    ei = ContractTestSupport.analyze_contract!(@with_exposing_pick, "Pick.elm")
  ...
  test "analyze_source parses module exposing list split across lines" do
    ei = ContractTestSupport.analyze_contract!(@multiline_exposing, "Multi.elm")
  ...
  test "analyze_source parses exposing list with constructor (..) inside parentheses" do
    ei = ContractTestSupport.analyze_contract!(@exposing_with_subparens, "SubPar.elm")
  ...
  test "analyze_source extracts top-level port names from source" do
    ei = ContractTestSupport.analyze_contract!(@with_ports, "Portm.elm")
  ...
  test "analyze_source extracts port names when the signature continues on the next line" do
    ei = ContractTestSupport.analyze_contract!(@with_ports_multiline, "PortML.elm")
  ...
  test "analyze_source extracts view_case_branches for case on model" do
    ei = ContractTestSupport.analyze_contract!(@view_case_model, "ViewMdl.elm")
  ...
  test "analyze_source extracts view_case_branches for case on model field access" do
    ei = ContractTestSupport.analyze_contract!(@view_case_page, "ViewPg.elm")
  ...
  test "analyze_source extracts update_case_branches for case on model field access" do
    ei = ContractTestSupport.analyze_contract!(@update_case_field, "UpdPg.elm")
  ...
  test "analyze_source extracts update_case_branches for top-level case msg" do
    ei = ContractTestSupport.analyze_contract!(@with_update, "Upd.elm")
  ...
  test "analyze_source extracts update_cmd_ops from case branches that return model,cmd tuples" do
    ei = ContractTestSupport.analyze_contract!(@update_case_with_tuples, "UpdCaseCmd.elm")
  ...
  test "analyze_source collects update_cmd_ops only from case branches with tuples" do
    ei = ContractTestSupport.analyze_contract!(@update_case_mixed_branch, "UpdMix.elm")
  ...
  test "analyze_source extracts update_cmd_ops when update is a top-level model,cmd tuple" do
    ei = ContractTestSupport.analyze_contract!(@update_top_tuple, "UpTup.elm")
  ...
  test "analyze_source extracts update_case_branches when case subject is first update param" do
    ei = ContractTestSupport.analyze_contract!(@with_update_m, "UpdM.elm")
  ...
  test "analyze_source extracts subscription_ops from batch list" do
    ei = ContractTestSupport.analyze_contract!(@with_subs, "Subm.elm")
  ...
  test "analyze_source merges subscription_ops from case branches when subject matches subscriptions params" do
    ei = ContractTestSupport.analyze_contract!(@subs_case, "SubCase.elm")
  ...
  test "analyze_source extracts subscription_ops from if expressions inside batch lists" do
    ei = ContractTestSupport.analyze_contract!(@subs_if_in_batch, "SubIfBatch.elm")
  ...
  test "analyze_source extracts subscription_calls through subscription wrapper calls" do
    ei = ContractTestSupport.analyze_contract!(@subs_wrapper_call, "SubWrapper.elm")
  ...
  test "analyze_source extracts subscription_ops from top-level if branches" do
    ei = ContractTestSupport.analyze_contract!(@subs_if_top_level, "SubIfTop.elm")
  ...
  test "analyze_source does not invent subscription_ops from unrecognized case subject" do
    ei = ContractTestSupport.analyze_contract!(@subs_case_bad, "SubBad.elm")
  ...
  test "analyze_source extracts init_cmd_ops from Cmd.batch in init" do
    ei = ContractTestSupport.analyze_contract!(@init_cmd_batch, "CmdBat.elm")
  ...
  test "analyze_source extracts init_cmd_ops from case branches returning model,cmd tuples" do
    ei = ContractTestSupport.analyze_contract!(@init_case_cmds, "InitCase.elm")
  ...
  test "analyze_source does not extract init_cmd_ops from case when subject is not a recognized init scrutinee" do
    ei = ContractTestSupport.analyze_contract!(@init_case_bad_subject, "InitBad.elm")
  ...
  test "analyze_source extracts main_program for Platform.worker-style main" do
    ei = ContractTestSupport.analyze_contract!(@with_main_worker, "Wkr.elm")
