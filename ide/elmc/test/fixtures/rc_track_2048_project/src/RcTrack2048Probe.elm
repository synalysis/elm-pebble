module RcTrack2048Probe exposing
    ( collapseRows
    , initialModel
    , leftMove
    , modelTurn
...
{-| Direction tag for host probes: 0 = Left, 1 = Right, 2 = Up, 3 = Down.
-}
...
reverseRowsHelp : List Int -> List Int
reverseRowsHelp cells =
...
transposeHelp : List Int -> List Int
transposeHelp cells =
    List.map
