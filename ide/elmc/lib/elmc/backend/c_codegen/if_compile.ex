defmodule Elmc.Backend.CCodegen.IfCompile do
  ...
  @spec if_result_out_binding(Types.compile_env(), Types.compile_counter()) :: {String.t(), Types.compile_counter(), boolean()}
  ...
  @spec int_if_chain_parse(Types.expr(), Types.expr(), Types.expr(), Types.compile_env()) ::
          {:ok, Types.expr(), [map()]} | :error
  ...
  @spec compile_branches_fallback(
          Types.expr(),
          Types.expr(),
          Types.expr(),
          Types.compile_env(),
  ...
  @spec compile_branches_fallback_runtime(
          Types.expr(),
          Types.expr(),
          Types.expr(),
          Types.compile_env(),
  ...
  @spec compile_runtime_native_bool_branches(
          Types.expr(),
          Types.expr(),
          Types.expr(),
          Types.compile_env(),
  ...
  @spec compile_platform_static_branches(
          String.t(),
  ...
  @spec compile_boxed_cond_branches(
          String.t(),
          String.t(),
          Types.expr(),
          Types.expr(),
  ...
  @spec complementary_bool_branches(Types.expr(), Types.expr(), Types.compile_env()) ::
          :cond_true | :cond_false | nil
  ...
  @spec bool_branch_polarity(map() | term()) :: boolean() | nil
  ...
  @spec normalize_branch_expr(term()) :: term()
  ...
  @spec branch_env(Types.compile_env(), String.t()) :: Types.compile_env()
  ...
  @spec format_if_branch_body(String.t()) :: String.t()

  defp format_if_branch_body(body) do
    CSource.format_block(body, 4)
  end

  @spec maybe_extract_if_branch_helper(
          Types.expr(),
          Types.compile_env(),
          String.t(),
          String.t(),
  ...
  @spec extract_if_branch_helper?(Types.compile_env(), String.t()) :: boolean()
  ...
  @spec inject_compare_operand_branch_releases(String.t(), String.t(), String.t()) ::
          {String.t(), String.t()}
  ...
  @spec list_equal_compare_operands(String.t()) :: [String.t()]
  ...
  @spec compare_operand_branch_release_prefix([String.t()], String.t(), boolean()) :: String.t()
  ...
  @spec operands_to_release_for_branch([String.t()], String.t(), boolean()) :: [String.t()]
  ...
  @spec compare_operand_release_stmt(String.t()) :: String.t()
