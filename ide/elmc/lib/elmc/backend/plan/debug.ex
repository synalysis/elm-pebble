defmodule Elmc.Backend.Plan.Debug do
  ...
  @spec format_instr(Types.t()) :: String.t()
  ...
  @spec format_dest(Types.result_slot() | integer() | nil) :: String.t()
  ...
  @spec format_effects(map()) :: String.t()
  ...
  @spec format_terminator(term()) :: String.t()
