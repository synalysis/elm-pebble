defmodule Elmc.Backend.Plan.Lower.Case.CharSwitch do
  ...
  @spec compile_arm_blocks(Types.ir_expr(), Types.ir_expr(), Types.ir_expr(), Types.ir_expr(), Types.ir_expr()) :: Types.ir_expr()
  ...
  @spec compile_tagged_arms(term(), Types.ir_expr(), Types.ir_expr(), Types.ir_expr(), term()) :: Types.ir_expr()
  ...
  @spec compile_default_arm(Types.ir_expr(), Types.ir_expr(), Types.ir_expr(), Types.ir_expr()) :: Types.ir_expr()
  ...
  @spec compile_one_arm(Types.ir_expr(), Types.ir_expr(), Types.ir_expr()) :: Types.ir_expr()
