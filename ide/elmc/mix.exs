defmodule Elmc.MixProject do
  ...
  defp aliases do
    [
      ...
      # Prefer the ulimit + per-template script (keeps CompileCache identity stable).
      # Do not expand this back into a single unbounded `mix test` of all templates.
      "test.plan_gates": ["cmd ../scripts/mix-test-plan-gates.sh"],
