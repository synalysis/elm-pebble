...
config :ide,
  ecto_repos: [Ide.Repo.Sqlite],
  ecto_adapter: Ecto.Adapters.SQLite3,
  repo_module: Ide.Repo.Sqlite,
  generators: [timestamp_type: :utc_datetime]

config :ide, Ide.Repo.Sqlite, priv: "priv/repo"
config :ide, Ide.Repo.Postgres, priv: "priv/repo"
...
config :ide, Ide.Debugger.RuntimeExecutor, execution_backend: :compiled_elixir

config :ide, Ide.Debugger.RuntimeExecutor.CompiledElixirAdapter, persist_generated_sources: false
...
config :esbuild,
  ...
  ide: [
    args:
      ~w(js/app.ts --bundle --format=esm --splitting --target=es2022 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
