defmodule IdeWeb.WorkspaceLive.DebuggerPreview.Core do
  @moduledoc false
  ...
  @spec animation_preview_op(Project.t(), pos_integer(), integer(), integer()) :: map() | nil
  ...
  @spec animation_node_id(map(), model_map()) :: integer() | nil
