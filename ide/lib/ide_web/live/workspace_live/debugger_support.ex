defmodule IdeWeb.WorkspaceLive.DebuggerSupport do
  ...
  defdelegate backend_drift_detail(compare, max_reason_len \\ 72),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics
  ...
  defdelegate debugger_rows(source, limit \\ 80),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate debugger_rows_for_mode(arg1, arg2),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate debugger_rows_for_target(rows, target),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline
  ...
  defdelegate diagnostics_preview_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics

  defdelegate diagnostics_preview_source_label(other),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics

  defdelegate debugger_contract_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics

  defdelegate elm_introspect_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics
  ...
  defdelegate filter_debugger_rows_for_display(arg1, arg2),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate filtered_event_summaries(events, kind, limit),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate filtered_event_summaries(events, kind, limit, query),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate format_debugger_contract_brief(arg1),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Export
  ...
  defdelegate key_target_drift_detail(compare, max_len \\ 72),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics

  defdelegate lifecycle_events_at_cursor(events, cursor_seq, limit \\ 12),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate max_seq(events), to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate maybe_reload(socket, rel_path, content, reason, source_root \\ nil),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Live

  defdelegate merge_drift_detail(backend_detail, key_target_detail),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics
  ...
  defdelegate payload_diff_json(base_event, compare_event),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate protocol_exchange_at_cursor(events, cursor_seq, limit \\ 40),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate refresh(socket), to: IdeWeb.WorkspaceLive.DebuggerSupport.Live

  defdelegate refresh_following_debugger_latest(socket),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Live

  defdelegate render_events_at_cursor(events, cursor_seq, limit \\ 24),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate rendered_node_bounds(tree, path, screen_w, screen_h, project \\ nil),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Rendered

  defdelegate rendered_node_summary(node, model, arg_name \\ nil),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Rendered
  ...
  defdelegate replay_compare(preview_rows, last_replay),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Replay

  defdelegate replay_live_drift(mode, preview_seq, events),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Replay

  defdelegate replay_live_drift_severity(drift), to: IdeWeb.WorkspaceLive.DebuggerSupport.Replay

  defdelegate replay_live_warning?(mode, preview_seq, events),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Replay

  defdelegate replay_metadata_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Replay
  ...
  defdelegate runtime_fingerprints_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Diagnostics

  defdelegate runtime_json(runtime), to: IdeWeb.WorkspaceLive.DebuggerSupport.Rendered

  defdelegate selected_debugger_row(source, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate seq_bounds(events), to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline

  defdelegate set_debugger_cursor_seq(socket, value),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Live

  defdelegate set_debugger_timeline_mode(socket, value),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Live

  defdelegate snapshot_runtime_at_cursor(events, cursor_seq),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Live
  ...
  defdelegate update_messages_at_cursor(events, cursor_seq, limit \\ 40),
    to: IdeWeb.WorkspaceLive.DebuggerSupport.Timeline
