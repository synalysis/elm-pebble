defmodule Ide.Compiler.ManifestCache do
  @moduledoc """
  In-memory cache for manifest results keyed by project slug and revision.
  """
  ...
  @type entry :: %{
          ...
          revision: String.t(),
          at: String.t(),
          result: Compiler.manifest_result()
        }
  ...
  @spec put(String.t(), String.t(), Compiler.manifest_result()) :: :ok
