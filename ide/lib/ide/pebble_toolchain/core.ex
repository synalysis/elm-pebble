defmodule Ide.PebbleToolchain.Core do
  @moduledoc """
  ...
  defp write_emulator_build_flags(app_root, opts) do
    ...
    #{watchface_define}#{storage_log_defines}#{probe_defines}#{heap_log_defines}#endif
    """
  ...
  @spec generate_elmc_sources(String.t(), String.t(), String.t()) ::
          :ok | {:error, toolchain_error()}
  ...
  @spec generate_companion_protocol_elm_internal(String.t() | nil) ::
          :ok | {:error, toolchain_error()}
