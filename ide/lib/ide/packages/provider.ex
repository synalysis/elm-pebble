defmodule Ide.Packages.Provider do
  ...
  @callback search(String.t(), keyword()) ::
              {:ok, [package_summary()]} | {:error, Types.catalog_error()}
  @callback package_details(String.t(), keyword()) ::
              {:ok, Types.package_details()} | {:error, Types.catalog_error()}
  @callback versions(String.t(), keyword()) ::
              {:ok, [String.t()]} | {:error, Types.catalog_error()}
  @callback package_release(String.t(), String.t(), keyword()) ::
              {:ok, Types.elm_json()} | {:error, Types.catalog_error()}
  @callback readme(String.t(), String.t(), keyword()) ::
              {:ok, String.t()} | {:error, Types.catalog_error()}
end
