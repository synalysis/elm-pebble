defmodule Ide.Debugger.BootstrapInit do
  ...
  @spec with_companion_bootstrap_flags(map()) :: map()
  ...
  @spec clear_companion_bootstrap_flags(map()) :: map()
  ...
  @spec defer_surface_effects?(map()) :: boolean()
  ...
  @spec take_defer_surface_effects(map()) :: {boolean(), map()}
