defmodule Ide.Debugger.CompileContract do
  ...
  @type wire_snapshot :: %{
          optional(String.t()) => contract() | String.t()
        }
  ...
  @spec build_from_project(Project.t(), Types.core_ir()) ::
          {:ok, contract()} | {:error, :entry_not_found | :parse_error}
  ...
  """
  @spec from_shell(Types.shell()) :: contract() | nil
  ...
  """
  @spec from_artifacts(Types.wire_map()) :: contract() | nil
  ...
  @spec default_entry_module_name(Types.core_ir()) :: String.t()
  ...
  @spec normalize_contract(contract() | Types.wire_map()) :: contract()
