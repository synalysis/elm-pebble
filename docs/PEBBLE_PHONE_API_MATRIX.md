...
| --- | --- | --- | --- | --- |
| AppMessage send/receive | Pebble companion bridge | `Pebble.Companion.Phone` / `Companion.Watch` | implemented (typed protocol) | Typed protocol helpers with decoders/encoders instead of raw integer pairs |
